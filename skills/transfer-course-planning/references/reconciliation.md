...
Common cases: AP Psychology and AP Human Geography each commonly map to Area 4, and because they are different disciplines both can fill Area 4's two-course requirement. AP Statistics commonly maps to Area 2. AP English Language commonly maps to Area 1A.
...
TAG is filed **September 1–30** of the year before transfer, with no late submissions. It is separate from and precedes the regular UC application. Typical thresholds at filing include 30+ UC-transferable semester units, a campus-specific GPA (roughly 3.0–3.4), and completion of first English composition and the math requirement by the end of the fall term. Screening majors add minimum GPA requirements across named preparation courses.
...
- Minimum 2.0 GPA
- Cal-GETC or CSU GE-Breadth certification
- Roughly 18+ semester units in the major per the statewide Transfer Model Curriculum (TMC), with C or better in each course
- Degree capped at 60 units
...
Do not state specific numbers here. Always send the student to the campus's own current page for the most accurate and up-to-date information.
